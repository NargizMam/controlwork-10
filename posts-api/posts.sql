...
VALUES ('Директор Британского музея подал в отставку после серии краж',
        '"Ситуация, в которой оказался музей, чрезвычайно серьёзна", – говорится в заявлении Хартвига Фишера. Бывший сотрудник подозревается в разграблении запасников и продаже части экспонатов на eBay.',null, DEFAULT);
INSERT INTO posts.news (title, text, image, createdAt)
    VALUES ('Миссия "Чандраян-3": первые шаги по Луне', 'Луноход индийской миссии "Чандраян-3" спустился по трапу и впервые прошел вблизи южного полюса спутника Земли
       ...
       Через несколько часов после посадки луноход "Чандраян-3" спустился по трапу и впервые прошел вблизи южного полюса спутника Земли.', null, DEFAULT);
INSERT INTO posts.news (title, text, image, createdAt)
...
INSERT INTO posts.comments (news_id, author, message) VALUES (1, null, 'Давно пора уходить');
INSERT INTO posts.comments (news_id, author, message) VALUES (2, 'John', 'India GOOOOO!!');
INSERT INTO posts.comments (news_id, author, message) VALUES (3, null, 'Если бы!');
INSERT INTO posts.comments (news_id, author, message) VALUES (2, 'Алекс', 'Верю в будущее прекрасное!');
INSERT INTO posts.comments (news_id, author, message) VALUES (1, null, '2222');
